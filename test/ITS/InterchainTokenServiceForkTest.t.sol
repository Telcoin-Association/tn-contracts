...
} from "@axelar-network/interchain-token-service/contracts/interfaces/IInterchainTokenService.sol";
...
contract InterchainTokenServiceForkTest is Test, ITSTestHelper {
    ...
    function test_sepoliaFork_itsInterchainTransfer_TEL() public {
        ...
        destinationChain = DEVNET_TN_CHAIN_NAME;
        vm.startPrank(linker);
        (, bytes32 returnedInterchainTokenId, TokenManager returnedTELTokenManager) = eth_registerCustomTokenAndLinkToken(
            originTEL,
            linker,
            destinationChain,
            deployments.its.InterchainTEL,
